    ...
    <main className={styles.main}>
      ...
      <div className={styles.descriptionBlock}>
        <p>
          ...
          heights. Just as a car needs to be in neutral, take a few deep breaths
          and center yourself.
        </p>
      </div>
      <div className={styles.subHeadingBlock}>
      ...
      <div className={styles.descriptionBlock}>
        <p>
          Early community members were rewarded with <strong>$VROOM</strong> as
          recognition for their commitment. With no fixed team, the road ahead
          is yours to navigate—create.<strong> $VROOM</strong> is about pushing
          boundaries and making your mark. Now, floor the accelerator.
        </p>
      </div>
      {/* <div className={styles.headingBlock}>
        <h2>Tokenomics</h2>
